...
import com.example.rickandmortyapicatalog.databinding.RowLoadingErrorBinding

class CharacterItemsLoadStateAdapter(
    private val onRetry: (() -> Unit)? = null
) : LoadStateAdapter<CharacterItemsLoadStateAdapter.ViewHolder>() {
